...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { tittle: @invitation.tittle, venue: @invitation.venue } }
    end
  ...
  #test "should update invitation" do
   # patch invitation_url(@invitation), params: { invitation: { tittle: @invitation.tittle, venue: @invitation.venue } }
